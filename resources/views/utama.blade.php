    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          ...
          <h3><a class="nav-link active" aria-current="page" href="{{url('komponenTBL')}}">Componen</a></h3>
        </li>
...
<body>
                <mb-9><center><h1>UAS WEB PROGRAMING LARAVEL</h></center></mb-9>
    <h3> Tugas Project UAS WEB PROGRAMING Laravel berisi CRUD dan DATABASE dengan project dari matakuliah Sensor AND Tranduser</h3>
